...
const EditBlog = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://blogify-backend.codewithabhinav.in/api/v1/blog/fetchblog/${id}`);
    ...
    const saveHandler = async () => {
        ...
        try {
            ...
            await axios.put(`https://blogify-backend.codewithabhinav.in/api/v1/blog/editblog/${id}`, {
                title: title,
                content: content
            });
            toast.dismiss();
