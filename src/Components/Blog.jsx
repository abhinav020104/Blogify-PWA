...
const Blog = ({ blogData }) => {
    ...
    const publishHandler = async () => {
        try {
            ...
            const response = await axios({
                method: "put",
                url: `https://blogify-backend.codewithabhinav.in/api/v1/blog/changepublishstatus/${blogData.id}/${status}`,
                data: {},
            });
    ...
    const handleDeleteBlog = async () => {
        try {
            ...
            const response = await axios({
                method: "delete",
                url: `https://blogify-backend.codewithabhinav.in/api/v1/blog/deleteblog/${blogData.id}`,
            });
            console.log(response);
            toast.dismiss();
